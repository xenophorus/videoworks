...
/**
 * TODO: 
 * 3D поворот (перспектива).
 * нулевые объекты при другом разрешении, на коллауте тоже
 * чтобы после запуска скрипта сразу была активна секвенция в essential graphics 
 * 
 */
